...
namespace HASAKI
{
    class KetNoi
    {
        private string strCon = @"Data Source =LAPTOP-KBRQ017O;Initial Catalog=QUANLYBANHANGHASAKI;Integrated Security=True";
        ...
        public DataTable LOGIN()
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("Select * from LOGIN", GetConnect());
            adapter.Fill(data);
            return data;
        }
